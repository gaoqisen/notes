<template><div><h2 id="一、动词分类" tabindex="-1"><a class="header-anchor" href="#一、动词分类" aria-hidden="true">#</a> 一、动词分类</h2>
<h3 id="_1-1-能做谓语" tabindex="-1"><a class="header-anchor" href="#_1-1-能做谓语" aria-hidden="true">#</a> 1.1 能做谓语</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 1、实意动词：walk、eat、make等</span>
<span class="token comment">// 及物动词：后面加宾语</span>
<span class="token class-name">I</span> hate you<span class="token punctuation">.</span> <span class="token comment">// 我讨厌你</span>
<span class="token comment">// 不及物动词：后面加宾语</span>
<span class="token class-name">I</span> fly<span class="token punctuation">.</span> <span class="token comment">// 我飞</span>
<span class="token comment">// 及物+不及物动词：根据情况加宾语</span>
...
<span class="token comment">// 2、系动词：is、are、look等</span>
be动词：am，is，are
感官动词：<span class="token function">feel</span><span class="token punctuation">(</span>感觉<span class="token punctuation">)</span>，<span class="token function">look</span><span class="token punctuation">(</span>看<span class="token punctuation">)</span>，<span class="token function">smell</span><span class="token punctuation">(</span>气味<span class="token punctuation">)</span>，<span class="token function">sound</span><span class="token punctuation">(</span>听<span class="token punctuation">)</span>，<span class="token function">seem</span><span class="token punctuation">(</span>似乎<span class="token punctuation">)</span>
变化动词：get，become，turn，<span class="token function">grow</span><span class="token punctuation">(</span>长大<span class="token punctuation">)</span>
保持动词：keep，<span class="token function">stay</span><span class="token punctuation">(</span>保持<span class="token punctuation">)</span>，<span class="token function">remain</span><span class="token punctuation">(</span>留下<span class="token punctuation">)</span>，<span class="token function">rest</span><span class="token punctuation">(</span>休息<span class="token punctuation">)</span>

<span class="token comment">// 3、静态动词own、cost、consist等</span>
拥有：have，own，want，<span class="token function">contain</span><span class="token punctuation">(</span>包含<span class="token punctuation">)</span>
情感：love，hate，want，need
思想：know，think，understand，believe

<span class="token comment">// 4、动词短语：come out（出来），depend on（取决于）， pay off（偿还）</span>
动词<span class="token operator">+</span>about：think about <span class="token comment">// 思考</span>
...
<p>需要加动词一起可以做谓语</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 1、助动词：have，do，shall，will，should，can等</span>
<span class="token comment">// 协助主要动词构成谓语的词，没有实际意思，不能单独用，构成时态、语态、否定句、强调句、疑问句。代表词have，do，be（不翻译意思就是猪动词）</span>
<span class="token comment">// have做助动词：构成完成时</span>
...
<span class="token class-name">Do</span> come <span class="token keyword">with</span> <span class="token namespace">you<span class="token punctuation">.</span></span>  <span class="token comment">// 一定要跟你去</span>
<span class="token comment">// be动词做助动词：构成进行时或被动语态</span>
...
<span class="token comment">// 2、情态动词：有含义，要和动词原形一起构成谓语（can，may，must，need等）</span>
<span class="token comment">// can/could表示推测、允许、能力</span>
<span class="token class-name">You</span> can imagine the story is bad<span class="token punctuation">.</span> <span class="token comment">// 你可以想象这个故事好不好</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-4-现在分词" tabindex="-1"><a class="header-anchor" href="#_5-4-现在分词" aria-hidden="true">#</a> 5.4 现在分词</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-5-过去分词" tabindex="-1"><a class="header-anchor" href="#_5-5-过去分词" aria-hidden="true">#</a> 5.5 过去分词</h3>
