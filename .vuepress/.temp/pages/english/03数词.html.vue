...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>// 个位数
-- 零	一	二	三	四	五	六	七	八	九
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>// 作数词时候，前面可以加数词，后面不能加s
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>// 如果数词用作名词时候，意思是好几…的时候，前面可以加some、many、several这种词或者加数词，后面可以加of
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>// 1、年龄
I’m twenty (我20岁)
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>// 表示时刻（中国人描述时间习惯精确到个位分钟，外国人描述时间习惯精确到十位分钟，几分钟一般省略）
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>// 个位数：第几（第零到第九）
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>// 使用序数词时，一般前面要加定冠词the
