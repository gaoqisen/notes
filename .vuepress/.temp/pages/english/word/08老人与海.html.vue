...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// was表示过去时，is表示当前时态。 </span>
...
<span class="token comment">// 辅音音素开头的单词使用 "a"，而以元音音素开头的单词使用 "an"</span>
<span class="token class-name">He</span> is an old man<span class="token punctuation">.</span> <span class="token comment">// 陈述句： 他是一个老人。  </span>

<span class="token comment">// 单独用who fish alonoe是语法错误，finsh的形式不对fished是谓语动词的过去式。完整的句子需要根据句子的时态变化</span>
who fished alone<span class="token punctuation">.</span>  <span class="token comment">// 谁独自钓鱼</span>
  
<span class="token comment">// 主语  系动词  补语        定语从句（who'关系代词引导定语从句'，fished是动词的过去式）</span>
   he   was    an old man  who fished alone<span class="token char">'修饰动词副词'</span><span class="token punctuation">.</span>  <span class="token comment">// 它是一个独自钓鱼的老人</span>

<span class="token comment">// 特点的已知概念定冠词the，事物用不定冠词a/an  </span>
in a skiff in the gulf stream  <span class="token comment">// 墨西哥湾流中的一叶小舟  </span>
...
*/</span>
he had gone eighty<span class="token operator">-</span>four days<span class="token punctuation">.</span>  <span class="token comment">// 他已经走了84天了</span>
<span class="token class-name">He</span>‘s been gone <span class="token keyword">for</span> eighty<span class="token operator">-</span>four days  <span class="token comment">//  意思是"他已经离开八十四天了"，用于描述某人离开的时间长度。</span>
  
now without taking a fish<span class="token punctuation">.</span>    <span class="token comment">// 句子不完整， 现在没拿一条鱼</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 辅音字母用a， days用复数</span>
...
<span class="token class-name">But</span> forty days without a fish the boy‘s parents had told him that the old man was now definitely and <span class="token keyword">finally</span> salao<span class="token punctuation">.</span> <span class="token comment">// 可使，一连四十天没有捕到鱼，男孩的父母对他说，老人现在准是被“衰神”附身了</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4、第五句" tabindex="-1"><a class="header-anchor" href="#_4、第五句" aria-hidden="true">#</a> 4、第五句</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 非限定性定语从句（关系从句），修饰前面的名词或代词，提供额外的信息。在这种情况下，"which is the worst"是定语从句，修饰"the unlucky"，说明在不幸中哪一个是最糟糕的。整个从句在句子中起到进一步解释和描述的作用。</span>
<span class="token comment">// 它提供了有关"salao"一词的额外信息。在这个上下文中，"which" 作为一个关系代词，连接这个从句与主句，阐明了"salao"是所指的"unlucky"的具体类型，从而对所讨论的术语进行了解释并提供了更多细节。</span>
which is the worst form of unluckly<span class="token punctuation">.</span>  <span class="token comment">// 真是不幸运中最糟糕的。  （真实倒霉透顶）</span>
  
the boy had gone at their orders   <span class="token comment">// 男孩按照他们（代他们的父母）的指示</span>
  
in another boat which caught three good fish the first week<span class="token punctuation">.</span>  <span class="token comment">// 在另一条船上第一个周就抓了3条好鱼</span>
...
*/</span>
<span class="token class-name">The</span> sail was patched <span class="token keyword">with</span> <span class="token namespace">flour</span> sacks and<span class="token punctuation">,</span> <span class="token comment">// 船帆用面粉袋打了些补丁</span>

furled<span class="token punctuation">,</span> <span class="token comment">// 卷着的</span>
...
*/</span>
it looked like the flag of permanent defeat<span class="token punctuation">.</span>  <span class="token comment">// 他看着像是永远失败的旗帜</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="第二段" tabindex="-1"><a class="header-anchor" href="#第二段" aria-hidden="true">#</a> 第二段</h2>
<h3 id="第一句" tabindex="-1"><a class="header-anchor" href="#第一句" aria-hidden="true">#</a> 第一句</h3>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
...
*/</span>
<span class="token class-name">The</span> old man was thin and gaunt <span class="token keyword">with</span> <span class="token namespace">deep</span> wrinkles in the back of his neck<span class="token punctuation">.</span>  
