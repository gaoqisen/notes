 ...
 * 
 */
in 在...离, on 在 ... 上, down, up, under 在 ... 之下，at 在
...
主、谓、宾、表、定、状、补、同。 比较难的是表语、定语、状语、补语
...
位置：放在be动词和系动词的后面。
*/
This table is long. (这个桌子是长的。)  // table就是表语
