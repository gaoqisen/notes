...
| 时态名称       | 结构                           | 用法说明                                                     | 时间状语示例               | 例句                          |
| -------------- | ------------------------------ | ------------------------------------------------------------ | -------------------------- | ----------------------------- |
| **一般现在时** | 主语 + 动词原形 / 第三人称单数 | 表示习惯性动作、客观事实或普遍真理。                         | always, usually, every day | I eat cherries for breakfast. |
| **一般过去时** | 主语 + 动词过去式              | 描述过去发生的动作或状态，与现在无关。                       | yesterday, last week       | I ate cherries yesterday.     |
| **一般将来时** | 主语 + will/shall + 动词原形   | 表示将来要发生的动作或存在的状态（美式多用 will，英式常用 shall）。 | tomorrow, next year        | I will eat cherries tomorrow. |
| **过去将来时** | 主语 + would/should + 动词原形 | 从过去角度看将来要发生的动作，常用于间接引语或虚拟语气。     | the next day, in 2024      | I said I would eat cherries.  |

进行时态

| 时态名称           | 结构                        | 用法说明                                                     | 时间状语示例         | 例句                               |
| ------------------ | --------------------------- | ------------------------------------------------------------ | -------------------- | ---------------------------------- |
| **现在进行时**     | 主语 + am/is/are + 现在分词 | 表示现在正在进行的动作，或现阶段持续的状态。                 | now, at present      | I am eating cherries now.          |
| **过去进行时**     | 主语 + was/were + 现在分词  | 描述过去某一时刻或阶段正在进行的动作。                       | at 8:00 last night   | I was eating cherries at 8:00 PM.  |
| **将来进行时**     | 主语 + will be + 现在分词   | 表示将来某一时刻正在进行的动作，强调计划性或自然延续性。     | at 9:00 tomorrow     | I will be eating cherries at 9:00. |
| **过去将来进行时** | 主语 + would be + 现在分词  | 从过去角度看将来某时刻正在进行的动作，常用于虚拟或假设语境。 | by 8:00 the next day | I said I would be eating cherries. |

完成时态

| 时态名称           | 结构                         | 用法说明                                                     | 时间状语示例             | 例句                                |
| ------------------ | ---------------------------- | ------------------------------------------------------------ | ------------------------ | ----------------------------------- |
| **现在完成时**     | 主语 + have/has + 过去分词   | 表示过去动作对现在的影响，或动作从过去持续到现在。           | already, yet, since 2020 | I have eaten cherries already.      |
| **过去完成时**     | 主语 + had + 过去分词        | 表示在过去某时间之前已完成的动作，形成 “过去的过去”。        | by the end of last year  | I had eaten cherries by 2024.       |
| **将来完成时**     | 主语 + will have + 过去分词  | 表示在将来某时间之前将完成的动作。                           | by tomorrow, in 5 years  | I will have eaten cherries by 9:00. |
| **过去将来完成时** | 主语 + would have + 过去分词 | 从过去角度看将来某时间前已完成的动作，常用于间接引语或虚拟语气。 | by the time you arrived  | I said I would have eaten cherries. |

完成进行时态

| 时态名称               | 结构                              | 用法说明                                                     | 时间状语示例               | 例句                                                       |
| ---------------------- | --------------------------------- | ------------------------------------------------------------ | -------------------------- | ---------------------------------------------------------- |
| **现在完成进行时**     | 主语 + have/has been + 现在分词   | 强调动作从过去开始持续到现在，可能继续进行。                 | for 2 hours, since morning | I have been eating cherries for an hour.                   |
| **过去完成进行时**     | 主语 + had been + 现在分词        | 表示在过去某时间之前一直持续的动作，强调延续性。             | before you arrived         | I had been eating cherries before you came.                |
| **将来完成进行时**     | 主语 + will have been + 现在分词  | 表示在将来某时间前将一直持续的动作，强调延续性。             | by the time you arrive     | I will have been eating cherries for two hours by then.    |
| **过去将来完成进行时** | 主语 + would have been + 现在分词 | 从过去角度看将来某时间前一直持续的动作，常用于虚拟或假设语境。 | when you came              | I said I would have been eating cherries when you arrived. |
